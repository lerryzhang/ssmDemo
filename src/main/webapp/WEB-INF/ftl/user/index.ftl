...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Bootstrap后台管理系统(lerry.zhang)</title>
		<meta name="keywords"
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									<strong class="green"> Ace后台管理系统 <small>(v1.2)</small>
											...
											<div
												...
												<div class="widget-toolbar no-border">
													...
													<ul
														...
														<li class="active">
															<a href="#" class="blue"> <i
																class="icon-caret-right bigger-110">&nbsp;</i> 本周 </a>
														</li>
													...
													<table class="table table-bordered table-striped">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<small> <s class="red">$24.99</s> </small>
																	<b class="green">$19.95</b>
																</td>

																<td class="hidden-480">
																	<span class="label arrowed"> <s>无货</s> </span>
																</td>
															</tr>
																...
																<li class="item-red clearfix">
																	...
																	<div class="pull-right action-buttons">
																		...
																		<a href="#" class="green"> <i
																			class="icon-flag bigger-130"></i> </a>
																	</div>
																</li>
																		...
																		<ul
																			...
																			<li>
																				<a href="#" class="tooltip-success"
																					...
																					<span class="green"> <i
																						class="icon-ok bigger-110"></i> </span> </a>
																			</li>

																			<li>
																				<a href="#" class="tooltip-error" data-rel="tooltip"
																					title="Delete"> <span class="red"> <i
																						class="icon-trash bigger-110"></i> </span> </a>
																			</li>
																		</ul>
																	</div>
																</li>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar"
																			src="${base}/assets/avatars/user.jpg" />
																	</div>
																				...
																				<ul
																					...
																					<li>
																						<a href="#" class="tooltip-warning"
																							...
																							class="orange"> <i
																								class="icon-remove bigger-110"></i> </span> </a>
																					</li>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar"
																			src="${base}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar"
																			src="${base}/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar"
																			src="${base}/assets/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar"
																			src="${base}/assets/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar"
																			src="${base}/assets/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar"
																			src="${base}/assets/avatars/avatar1.png" />
																	</div>
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<div class="dialogs">
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="${base}/assets/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="${base}/assets/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="${base}/assets/avatars/avatar4.png" />
															</div>
...
<![endif]-->
		...
		<script type="text/javascript">
	window.jQuery || document.write("__tag_1856$36_" + "__tag_1856$83_");
</script>
...
<![endif]-->
	...
	if ("ontouchend" in document)
		document.write("__tag_1868$48_" + "__tag_1868$103_");
</script>
